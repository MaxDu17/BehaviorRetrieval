...
class VAEEmbeddingConfig(BaseConfig):
    ALGO_NAME = "vae_embedding"
    ...
    def algo_config(self):
        ...
        self.algo.optim_params.VAE.learning_rate.initial = 1e-4  # policy learning rate
        self.algo.optim_params.VAE.learning_rate.decay_factor = 0.1  # factor to decay LR by (if epoch schedule non-empty)
        self.algo.optim_params.VAE.learning_rate.epoch_schedule = []  # epochs where LR decay occurs
        self.algo.optim_params.VAE.regularization.L2 = 0.00  # L2 regularization strength
