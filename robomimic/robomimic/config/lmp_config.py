...
class LMPConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        self.algo.plan_recognition_dims = (2048,)
        self.algo.plan_proposal_dims = (2048, 2048, 2048, 2048)
        self.algo.policy_network_dims = (2048, 2048)
        self.algo.visual_encoder_dims = (256, 256)
